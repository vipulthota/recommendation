...
class Gaming:
    ...
    def __casual_game_score(self,value:dict)->float:
        ...
        score = ((ram_normalised * 7) + (price_normalised*12) + (storage_normalised * 6) + (screen_normalised * 7) + 
                    + (cpu_ranking_normalised * 6) + (gpu_ram_normalised * 5) + (screen_size_normalised * 5) + (gpu_score_normalised * 7)
    ...
    def __heavy_game_score(self,value:dict)->float:
        ...
        score = ((ram_normalised * 7) + (price_normalised*4) + (storage_normalised * 6) + (screen_normalised * 5) + 
                    + (cpu_ranking_normalised * 10) + (gpu_ram_normalised * 5) + (screen_size_normalised * 6) + (gpu_score_normalised * 11)
...
class Student:
    ...
    def __light_student_score(self,value:dict)->float:
        ...
        score = ((ram_normalised * 6) + (price_normalised*12) + (storage_normalised * 7) + (screen_normalised * 4) + 
                    + (cpu_ranking_normalised * 5) + (screen_size_normalised * 5)
                    + (ram_type_normalised*4) + (weight_normalised*7) + (gpu_score_normalised * 3) + (battery_normalised*7))
    ...
    def __heavy_student_score(self,value:dict)->float:
        ...
        score = ((ram_normalised * 7) + (price_normalised*8) + (storage_normalised * 6) + (screen_normalised * 5) + 
                    + (cpu_ranking_normalised * 8) + (screen_size_normalised * 3)
                    + (ram_type_normalised*5) + (weight_normalised*4) + (gpu_score_normalised * 8) 
                    + (gpu_ram_normalised * 3) + (battery_normalised*3))
...
class Business:
    ...
    def __business_score(self,value:dict)->float:
        ...
        score = ((ram_normalised * 7) + (price_normalised*4) + (storage_normalised * 6) + (screen_normalised * 8) + 
                    + (cpu_ranking_normalised * 6) + (screen_size_normalised * 6)
